...
-   [Getting Started: ~/.condarc configuration file](https://uf-splab.github.io/mne-wiki/posts/share-hpg-envs/#getting-started-conda-configuration)

-   then to [Copy the template_kernelfolder to your path](https://uf-splab.github.io/mne-wiki/posts/share-hpg-envs/#copy-the-template_kernel-folder-to-your-path)
